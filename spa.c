...
///////////////////////////////////////////////////////////////////////////////////////////////
double julian_day (int year, int month, int day, int hour, int minute, int second, float tz)
{
...
double julian_ephemeris_day(double jd, float delta_t)
{
...
double observer_hour_angle(double nu, float longitude, double alpha_deg)
{
...
void sun_right_ascension_parallax_and_topocentric_dec(float latitude, float elevation, double xi,
...
*delta_alpha = rad2deg(atan2(-x*sin(xi_rad)*sin(h_rad), cos(delta_rad) -
x*sin(xi_rad)*cos(h_rad)));
*delta_prime = rad2deg(atan2((sin(delta_rad) - y*sin(xi_rad))*cos(*delta_alpha),
